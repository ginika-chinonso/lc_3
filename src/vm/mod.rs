        ...
        match opcode {
            Opcodes::Br => {
                ...
                if (nzp & cond) > 0 {
                    self.set_register(
                        Register::Pc as u16,
                        sign_extend(pc_offset_9, 9) + self.get_register(Register::Pc as u16),
                    );
                }
            }
            ...
            Opcodes::Jsr => {
                ...
                if ((instruction >> 11) & 1) == 1 {
                    ...
                    self.set_register(
                        Register::Pc as u16,
                        sign_extend(pc_offset_11, 11) + self.get_register(Register::Pc as u16),
                    );
                } else {
            ...
            Opcodes::Ldr => {
                ...
                self.set_register(
                    dr,
                    self.mem_read(sign_extend(offset_6, 6) + self.get_register(base_r)),
                );
                self.update_flag(dr);
            }
            ...
            Opcodes::Str => {
                ...
                let offset_6 = instruction & 0x3F;
                self.mem_write(
                    sign_extend(offset_6, 6) + self.get_register(base_r),
                    self.get_register(sr),
                );
            }
...
fn twos_complement(value: u16) -> u16 {
    todo!()
}
...
mod tests {
    ...
    fn test_ldi_instruction() {
        ...
        let pc_offset = 0xBB;
        let memory_address = sign_extend(pc_offset, 9) + vm.get_register(Register::Pc as u16);
    ...
    fn test_br_instruction() {
        ...
        // Instruction
        // 575 -> 0000 010 101110101 -> Throwing overflow error
